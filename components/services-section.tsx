...
import { Box, Lightbulb, Car, Shield, ChevronRight, ChevronLeft, Hammer, Palette } from "lucide-react"

const services = [
  {
    title: "Letreros Corpóreos 3D",
    subtitle: "Relieve y Elegancia Corporativa",
    description: "Letras y logotipos 3D personalizados fabricados en polyfan, acrílico, chapa galvanizada, acero y PVC. Ideales para recepciones, oficinas y fachadas comerciales. Incorporamos retroiluminación LED premium (efecto halo) para asegurar máxima visibilidad, distinción y elegancia institucional las 24 horas.",
    icon: Box,
    images: [
      "/corporeo-xeroff.jpg",
      "/usecase-corporativo.png",
      "/costa_nueva.JPEG"
    ],
    accent: "text-yellow-400 border-yellow-500/20 bg-yellow-500/5",
    details: [
      "Diseño a medida y relieve 3D flotante",
      "Materiales premium: acrílico, chapa y polyfan",
  ...
  },
  {
    ...
    description: "Diseño y fabricación de carteles luminosos, marquesinas de gran formato y letreros comerciales. Especialistas en cartelería Frontlight y Backlight con lona tensada premium impresa en alta resolución. Incorporamos sistemas de iluminación LED de alta eficiencia energética para destacar tu local tanto de día como de noche.",
    icon: Lightbulb,
    images: [
      "/dulcereino.JPEG",
      "/neon-led.jpg",
  ...
  {
    title: "Estructuras y Herrería Comercial",
    subtitle: "Soporte Seguro y Armado a Medida",
    description: "Planificación, soldadura, armado y montaje de estructuras de hierro reforzado y caño estructural para carteles comerciales, tótems y marquesinas de gran porte. Diseñamos estructuras robustas preparadas para resistir vientos fuertes y factores climáticos extremas, garantizando máxima seguridad edilicia.",
    icon: Hammer,
    images: [
      "/estacion-shell-canopy.jpg",
      "/vibra.JPEG",
      "/soria3.JPEG"
    ],
    accent: "text-emerald-400 border-emerald-500/20 bg-emerald-500/5",
    details: [
      "Soldadura profesional en caño estructural",
      "Pórticos de ingreso y tótems de altura",
      "Tratamiento antioxidante de alta resistencia",
      "Montaje en altura con normas de seguridad"
    ]
  },
  {
  ...
  {
    title: "Señalización Industrial & Vial",
    subtitle: "Seguridad y Organización Profesional",
    description: "Producción de cartelería institucional y de seguridad bajo estrictas normas IRAM para fábricas, plantas industriales, almacenes y oficinas. Desarrollamos carteles de salidas de emergencia, indicativos viales, tótems informativos de GNC/Combustible, demarcación de peligro y señalética corporativa interna y externa.",
    icon: Shield,
    images: [
      "/estacion-shell-totem.jpg",
      "/industrial-signage-factory-manufacturing-dark.jpg",
      "/industrial-signage-manufacturing-workshop.jpg"
    ],
    accent: "text-orange-400 border-orange-500/20 bg-orange-500/5",
    details: [
      "Carteles de seguridad según normas IRAM",
      "Chapas galvanizadas y materiales reflectivos",
      "Tótems e indicadores viales de alta visibilidad",
      "Señalética interna para plantas industriales"
    ]
  },
  {
    title: "Identidad Visual & Vidrieras",
    subtitle: "Diseño y Branding Integral para Locales",
    description: "Llevamos la identidad de tu marca a la realidad. Ploteo decorativo e institucional de vidrieras, aplicación de vinilos esmerilados para privacidad en oficinas, rotulación de interiores comerciales y diseño gráfico publicitario adaptado. Te asesoramos desde el diseño del logotipo hasta la instalación final en tu nuevo local.",
    icon: Palette,
    images: [
      "/usecase-barberia.png",
      "/usecase-boliche.png",
      "/alyna.JPEG"
    ],
    accent: "text-cyan-400 border-cyan-500/20 bg-cyan-500/5",
    details: [
      "Ploteo de vidrieras con vinilo de corte o impreso",
      "Vinilo esmerilado premium para oficinas y mamparas",
      "Decoración comercial de interiores y paredes",
      "Branding integral y diseño gráfico publicitario"
    ]
  }
]
